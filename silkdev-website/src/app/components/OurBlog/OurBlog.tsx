                ...
                <div className={styles.carddetails}>
                  ...
                  <div className={styles.containeravatar}>
                    ...
                    <div className={styles.containeravatarclm}>
                      ...
                      <p className={styles.avatarp}>{blog.date}</p>
                    </div>
                    <svg

...
<div className={styles.card}>
  ...
  <div className={styles.carddetails}>
    ...
    <div className={styles.name}>Use the bluetooth SMS andwidth,<br/> then you can</div>

    <p className={styles.p}>
    Compressing the monitor won't do anything, we need to<br/> synthesize the cross-platform HTTP feed.</p>
<div className={styles.containeravatar}>
    <Image src={avatar} alt="Avatar" className={styles.avatar}/>
    <div className={styles.containeravatarclm}>
    <h1 className={styles.avatarh1}>Darlene Robertson</h1>
    <p className={styles.avatarp}>March 12, 2021</p></div> 
